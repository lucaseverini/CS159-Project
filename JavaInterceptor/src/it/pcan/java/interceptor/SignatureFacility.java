...
class SignatureFacility {
    ...
    private void fillReferences(MethodSignature signature) throws InvalidClassException {
		...
		System.out.println(signature.getParamTypes());
        ...
        for (String paramType : signature.getParamTypes()) {
            ...
            if(reference == -1) 
			{
				...
				System.out.println("Reference to utf8 string '" + paramType + "' not found in Constant Pool.");
            }
			else
			{
		...
		if(i == signature.getParamTypes().size())
		{
